...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  // Simple local toggles (UI only for now)
          ...
          builder: (ctx, setStateDialog) {
            Future<void> handleUpdate() async {
              ...
              if (success) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Failed to change password. Check your current password and try again.'),
            ...
            return AlertDialog(
              ...
              actionsPadding:
                  const EdgeInsets.only(bottom: 12, right: 16, top: 8),
              actions: [
                TextButton(

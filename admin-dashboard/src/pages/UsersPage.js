      ...
      <div className="flex flex-col gap-4">
        {sortedUsers.map(u => {
          ...
          return (
            <div
              key={u.id}
              className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row justify-between items-center hover:border-primary/30 transition-colors"
            >
              {/* User Info */}
